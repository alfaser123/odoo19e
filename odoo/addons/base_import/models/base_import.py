...
class Base_ImportImport(models.TransientModel):
    ...
    def get_fields_tree(self, model, depth=FIELDS_RECURSION_LIMIT):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       get_fields_tree--------------')
    ...
    def _read_file(self, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py        _read_file--------------')
    ...
    def _read_xls(self, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _read_xls--------------')
    ...
    def _read_xls_book(self, book, sheet_name):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _read_xls_book--------------')
        import xlrd  # noqa: PLC0415
    ...
    def _read_xlsx(self, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _read_xlsx---------------')
        try:
    ...
    def _read_csv(self, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _read_csv   ---------------'+ 'ini')
        ...
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _read_csv    csv_data   ---------------'+ str(csv_data))
        if not csv_data:
            return ()
    ...
    def _extract_header_types(self, preview_values, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _extract_header_types---------------')
    ...
    def _try_match_date_time(self, preview_values, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _try_match_date_time--------------')
    ...
    def _extract_headers_types(self, headers, preview, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _extract_headers_types--------------')
        """
    ...
    def _get_mapping_suggestion(self, header, fields_tree, header_types, mapping_fields):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _get_mapping_suggestion---------------')
    ...
    def _get_mapping_suggestions(self, headers, header_types, fields_tree):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _get_mapping_suggestions--------------')
    ...
    def parse_preview(self, options, count=10):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       parse_preview--------------')
    ...
    def _convert_import_data(
        ...
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _convert_import_data--------------')
    ...
    def _parse_float_from_data(self, data, index, name, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _parse_float_from_data--------------')
        for line in data:
    ...
    def _parse_import_data_recursive(self, model, prefix, data, import_fields, options):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _parse_import_data_recursive--------------')
    ...
    def _import_file_by_url(self, url, session, field, line_number):
        ...
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _import_file_by_url--------------')
    ...
    def execute_import(self, fields, columns, options, dryrun=False):
        ...
        """
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       execute_import--------------')
    ...
    def _extract_binary_filenames(self, import_fields, data, model=False, prefix='', binary_filenames=False):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _extract_binary_filenames--------------')
    ...
    def _handle_multi_mapping(self, import_fields, input_file_data):
        ...
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _handle_multi_mapping--------------')
        ...
        merged_data = []
        _logger.info('--------   input_file_data   input_file_data-----'+str(input_file_data))
        for record in input_file_data:
            _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _handle_multi_mapping  record -----'+str(record))
            new_record = []
    ...
    def _handle_fallback_values(self, import_field, input_file_data, fallback_values):
        _logger.info('--------/usr/lib/python3/dist-packages/odoo/addons/base_import/models/base_import.py       _handle_fallback_values--------------')
        """
