...
export class WebEnvironmentRibbonHorizontal extends Component {
    setup() {
...
WebEnvironmentRibbonHorizontal.props = {};
WebEnvironmentRibbonHorizontal.template = xml`<div class="test-ribbon" />`;

registry.category("main_components").add("WebEnvironmentRibbonHorizontal", {
    Component: WebEnvironmentRibbonHorizontal,
});
